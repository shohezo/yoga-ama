...
<section class="ly_section hp_ptLg hp_pbLg" id="feature">
    <div class="ly_inner">
...
<section class="ly_section hp_ptLg hp_pbLg" id="voice">
    <div class="ly_inner">
...
<section class="ly_section hp_ptLg hp_pbLg" id="photo">
    <div class="ly_inner">
        ...
        <span class="el_section_ttl_sub hp_mbMd">フォトギャラリー</span>
